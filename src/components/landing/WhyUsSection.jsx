      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeUp} custom={0} className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-accent font-semibold text-sm tracking-widest uppercase font-body">Pourquoi nous ?</span>
            <div className="h-px w-8 bg-accent" />
          </motion.div>
          ...
          <motion.p variants={fadeUp} custom={2} className="text-muted-foreground text-lg mt-6 font-body">
        ...
        >
          <div>
            <h3 className="font-heading font-extrabold text-2xl text-primary-foreground">Prêt à travailler avec nous ?</h3>
            <p className="text-primary-foreground/60 font-body mt-2">Devis gratuit · Réponse sous 24h · Aucun engagement</p>
          </div>
          <a
            href="#contact"
